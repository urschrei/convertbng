...
static PyObject *__pyx_pw_10convertbng_5cutil_5cutil_1convert_bng(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("convert_bng (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_lons,&__pyx_n_s_lats,0};
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_v_lons.shape[0];
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_v_lats.shape[0];
