...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "/Users/sth/dev/convertbng/convertbng/cutil.pyx"
        ]
    }, 
...
static PyObject *__pyx_f_10convertbng_5cutil_ffi_wrapper(struct _Result_Tuple (*)(struct _FFIArray, struct _FFIArray)); /*proto*/
...
static PyMethodDef __pyx_mdef_10convertbng_5cutil_11ffi_wrapper_1wrapped = {"wrapped", (PyCFunction)__pyx_pw_10convertbng_5cutil_11ffi_wrapper_1wrapped, METH_VARARGS|METH_KEYWORDS, 0};
...
static PyObject *__pyx_f_10convertbng_5cutil_ffi_wrapper(struct _Result_Tuple (*__pyx_v_func)(struct _FFIArray, struct _FFIArray)) {
  struct __pyx_obj_10convertbng_5cutil___pyx_scope_struct____pyx_f_10convertbng_5cutil_ffi_wrapper *__pyx_cur_scope;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init convertbng.cutil", 0, __pyx_lineno, __pyx_filename);
    }
